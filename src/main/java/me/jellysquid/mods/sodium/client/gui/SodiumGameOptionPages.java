    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        ...
                        .setControl(o -> new SliderControl(o, 0, Runtime.getRuntime().availableProcessors(), 1, ControlValueFormatter.quantityOrDisabled(new TranslatableText("sodium.options.chunk_update_threads.value.unit").getString(), new TranslatableText("sodium.options.chunk_update_threads.value.default").getString())))
                        .setImpact(OptionImpact.HIGH)
